...
public class QuestionDTO {
    ...
    @Schema(description = "List of possible answer options",
            example = "[\"Christopher Nolan\", \"Steven Spielberg\", \"Ridley Scott\", \"James Cameron\"]")
    private List<String> options;

    @Schema(description = "Token that encodes the question identity (typically a JWT)",
            example = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ0dDAwMTIzNDUifQ.sometokenvalue")
    private String token;

    @Schema(description = "Type of question (e.g., DIRECTOR, ACTOR, GENRE, YEAR)", example = "DIRECTOR")
    private QuestionType type;

    @Schema(description = "URL of an image related to the question (e.g., movie poster)",
