      ...
      <div className="max-w-2xl w-full animate-fade-in">
        <Card className="glass-card cinema-glow">
          <CardHeader className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">Hall of Fame - Top Movie Quiz Champions</p>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="pt-4">
              <Button onClick={handleBackToHome} variant="outline" className="w-full h-12 text-lg" size="lg">
